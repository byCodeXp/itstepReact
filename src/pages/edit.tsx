...
export class EditPage extends Component<{ contact?: IContact; onFinish: any; onDelete: any; }> {
   state = {
   ...
   handleOnDelete = () => {
      this.props.onDelete(this.state.contact.id);
      this.setState({ ...this.state, isRedirect: true });
   }
         ...
         <div className="w-ful mt-8 transition">
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
               <div className="w-full px-3">
                  ...
                  <input
                     ...
                     defaultValue={this.props.contact?.photo}
                     onChange={(e) =>
                        this.setState({
                           ...this.state,
                           contact: {
                              ...this.state.contact,
                              preivew: e.target.value,
                           },
                        })
                     }
                  />
               ...
               <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                  ...
                  <div className="relative">
                     <select
                        ...
                        id="grid-gender"
                        defaultValue={this.props.contact?.gender}
                        onChange={(e) =>
                           this.setState({
                              ...this.state,
                              contact: {
            ...
            <div className="flex flex-wrap -mx-3 mb-6 mt-6">
               <div className="w-full px-3 flex items-center justify-between">
                  <button
                     className="bg-red-600 hover:bg-red-500 text-white font-bold py-2 px-8 rounded focus:outline-none focus:shadow-outline"
                  ...
                  <div>
                     <button
                        className="bg-gray-600 hover:bg-gray-500 text-white font-bold py-2 px-8 rounded focus:outline-none focus:shadow-outline mr-4"
                        onClick={() =>
                           this.setState({ ...this.state, isRedirect: true })
                        }
                     >
